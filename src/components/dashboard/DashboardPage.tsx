...
const CHANGELOG: { version: string; date: string; changes: string[] }[] = [
  ...
  },
  {
    ...
    date: '2026-06-04',
    changes: [
      'Fix: printed/PDF invoice Total row no longer repeats on every page — moved out of <tfoot> (which browsers stamp on each printed page) into the table body so it appears exactly once at the natural end of the table',
    ],
  },
  {
    version: '1.5.10',
    date: '2026-06-04',
    changes: [
      'Edit Payment button on paid invoices — adjust payment date, USD-received amount, and note in place without reverting to draft and re-marking sent/paid',
    ],
  },
  {
    version: '1.5.9',
  ...
  },
  {
    ...
    date: '2026-05-06',
    changes: [
      'Per-invoice Bill To override — correct the recipient name and address on a single invoice (e.g., to fix a sent invoice and resend) without altering the company record or other past invoices; "Edit" button on the invoice detail panel, with a "Reset to company defaults" option when an override is set',
    ],
  },
  {
    version: '1.5.5',
    date: '2026-05-05',
    changes: [
      'Payment Information on invoices now renders one item per line in both print/PDF and Word exports (was a single horizontal row separated by pipes)',
    ],
  },
  {
    version: '1.5.4',
    date: '2026-05-05',
    changes: [
      'Bank Name and Account Name fields added to Business Profile — render in the Payment Information block of both print/PDF and Word invoice exports for wire transfer details',
    ],
  },
  {
    version: '1.5.3',
    date: '2026-05-05',
    changes: [
      'Per-company billing address — added a Billing Address field to the company form; multi-line address renders under the company name in the Bill To section of both print/PDF and Word invoice exports',
    ],
  },
  {
    version: '1.5.2',
    date: '2026-05-05',
    changes: [
      'Per-company VAT notice text — override the default EU directive language on a per-client basis (e.g., for UK or non-EU jurisdictions); textarea appears under the VAT reverse charge toggle on the company form, default text is used when blank',
    ],
  },
  {
    version: '1.5.1',
  ...
  },
  {
    ...
    date: '2026-03-14',
    changes: [
      'Invoice detail level toggle: choose "Summarize by week" or "Individual entries" when creating an invoice',
      'Individual entries mode shows each time entry as its own row (date, description, hours, amount) in invoice preview, print/PDF, and Word export',
    ],
  },
  {
    version: '1.4.2',
    date: '2026-03-14',
    changes: [
      'Custom line items on invoices — add ad-hoc charges (expenses, travel, materials, etc.) alongside time entries',
      'Line items editable on draft invoices with quantity, unit price, and amount fields',
      'Line items included in invoice totals, print/PDF, and Word export',
    ],
  },
  {
    version: '1.4.1',
    date: '2026-03-11',
    changes: [
      'EU/UK VAT reverse charge support for international B2B invoicing',
      'New company toggle: "EU/UK client — VAT reverse charge applies"',
      'Invoice print/PDF and Word exports auto-include reverse charge notation with EIN',
      '"VAT RC" badge on company cards for quick identification',
    ],
  },
  {
    version: '1.4',
  ...
  },
  {
    ...
    date: '2026-03-06',
    changes: [
      'Default Reports page to Current Year period',
    ],
  },
  {
    version: '1.3.2',
